...
use veilid_core::{
    RouteId, Target, VeilidAPI, VeilidAPIError, VeilidAPIResult, VeilidConfig, VeilidConfigProtectedStore, VeilidConfigTableStore, VeilidUpdate, api_startup_config, tools
};
...
pub async fn send_message(veildid: &str) -> Result<(), Box<dyn std::error::Error>>  {
